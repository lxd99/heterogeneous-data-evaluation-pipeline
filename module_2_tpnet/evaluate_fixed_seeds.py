...
if __name__ == "__main__":
    ...
    if args.model_name == 'EdgeBank':
        ...
        run_offset = int(os.environ.get("TPNET_EVAL_RUN_OFFSET", "0"))
        for run in range(run_offset, run_offset + args.num_runs):
            ...
            save_result_dir = os.environ.get("TPNET_EVAL_RESULT_DIR", "./saved_results")
            os.makedirs(save_result_dir, exist_ok=True)
            save_result_path = os.path.join(
                save_result_dir,
                f"{args.prefix}_link_{args.negative_sample_strategy}_{args.dataset_name}_{args.model_name}_seed{args.seed}.json",
            )
