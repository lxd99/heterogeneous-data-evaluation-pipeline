...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        args.seed = run
        args.load_model_name = os.environ.get('DYGKT_LOAD_MODEL_TEMPLATE', '{model}_seed{seed}').format(model=args.model_name, seed=args.seed)
        args.save_result_name = os.environ.get("DYGKT_RESULT_PREFIX", "") + f"{args.negative_sample_strategy}_negative_sampling_{args.model_name}_seed{args.seed}"
